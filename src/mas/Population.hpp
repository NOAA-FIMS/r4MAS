...
#warning hard coded value initialF
        ...
        void Initialize() {
            ...
            for (af_it = this->area->active_fleets.begin();
                    af_it != this->area->active_fleets.end(); ++af_it) {
                (*af_it)->f_at_age[this->area->id][this->id].resize(
                        years * seasons * ages.size());
                (*af_it)->z_at_age[this->area->id][this->id].resize(
                        years * seasons * ages.size());
                if (this->sex == mas::MALE) {
                    (*af_it)->f_at_age_males[this->area->id][this->id].resize(
                            years * seasons * ages.size());
                    (*af_it)->z_at_age_males[this->area->id][this->id].resize(
                            years * seasons * ages.size());
                } else {
                    (*af_it)->f_at_age_females[this->area->id][this->id].resize(
                            years * seasons * ages.size());
                    (*af_it)->z_at_age_females[this->area->id][this->id].resize(
                            years * seasons * ages.size());
                }
            }

            length_at_season_start.resize(
                    length_weight_key_carryout
                    + this->years * this->seasons * this->ages.size() + 1);
            length_at_spawning.resize(
                    length_weight_key_carryout
                    + this->years * this->seasons * this->ages.size());
            length_at_catch_time.resize(
                    length_weight_key_carryout
                    + this->years * this->seasons * this->ages.size());
            length_at_survey_time.resize(
                    length_weight_key_carryout
                    + this->years * this->seasons * this->ages.size());
            weight_at_season_start.resize(
                    length_weight_key_carryout
                    + this->years * this->seasons * this->ages.size() + 1);
            weight_at_spawning.resize(
                    length_weight_key_carryout
                    + this->years * this->seasons * this->ages.size());
            weight_at_catch_time.resize(
                    length_weight_key_carryout
                    + this->years * this->seasons * this->ages.size());
            weight_at_survey_time.resize(
                    length_weight_key_carryout
                    + this->years * this->seasons * this->ages.size());
            equilibrium_to_survival_at_spawning.resize(
                    years * seasons * ages.size());
...
#warning needs to be more efficient, possibly allocating unused memory
        ...
        inline void Reset() {
            ...
            std::fill(this->survey_biomass_total.begin(),
                    this->survey_biomass_total.end(), static_cast<REAL_T> (0.0));
            for (int i = 0; i < numbers_at_age.size(); i++) {
                mas::VariableTrait<REAL_T>::SetValue(numbers_at_age[i],
                        static_cast<REAL_T> (0.0));
            }

            for (int i = 0; i < survey_numbers_at_age.size(); i++) {
                mas::VariableTrait<REAL_T>::SetValue(emigrants[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(emigrants_biomass[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(imigrants[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(imigrants_biomass[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(growth[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(Z[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(F[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(P[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(S[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(biomass_at_age[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(survey_numbers_at_age[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(survey_index_at_age[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(catch_at_age[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(catch_biomass_at_age[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(expected_N[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(fecundity_at_age[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(
                        equilibrium_to_survival_at_spawning[i],
                        static_cast<REAL_T> (0.0));
            }

            for (int i = 0; i < recruitment.size(); i++) {
                mas::VariableTrait<REAL_T>::SetValue(recruitment[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(redistributed_recruits[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(immigrant_recruits[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(emigrant_recruits[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(abundance[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(spawning_stock_biomass[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(biomass_total[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(fishing_mortality_total[i],
                        static_cast<REAL_T> (0.0));
            }
            for (int i = 0; i < this->initial_numbers.size(); i++) {
                mas::VariableTrait<REAL_T>::SetValue(initial_numbers[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(initial_equilibrium_numbers[i],
                        static_cast<REAL_T> (0.0));

            }

            for (int i = 0; i < this->sum_selectivity.size(); i++) {
                mas::VariableTrait<REAL_T>::SetValue(this->sum_selectivity[i],
                        static_cast<REAL_T> (0.0));
            }

            for (int i = 0; i < this->length_at_spawning.size(); i++) {
                mas::VariableTrait<REAL_T>::SetValue(weight_at_season_start[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(length_at_season_start[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(length_at_spawning[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(length_at_catch_time[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(length_at_survey_time[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(weight_at_spawning[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(weight_at_catch_time[i],
                        static_cast<REAL_T> (0.0));
                mas::VariableTrait<REAL_T>::SetValue(weight_at_survey_time[i],
                        static_cast<REAL_T> (0.0));
            }
            mas::VariableTrait<REAL_T>::SetValue(
                    weight_at_season_start[this->length_at_spawning.size()],
                    static_cast<REAL_T> (0.0));
            mas::VariableTrait<REAL_T>::SetValue(
                    length_at_season_start[this->length_at_spawning.size()],
                    static_cast<REAL_T> (0.0));
            std::unordered_set<int>::iterator fit;
            for (fit = this->active_fleets.begin();
                    fit != this->active_fleets.end(); ++fit) {
                std::fill(F_at_age[(*fit)].begin(), F_at_age[(*fit)].end(),
                        static_cast<REAL_T> (0.0));
                std::fill(Z_at_age[(*fit)].begin(), Z_at_age[(*fit)].end(),
                        static_cast<REAL_T> (0.0));
            }
            typename Area<REAL_T>::active_fleets_iterator af_it;
            for (af_it = this->area->active_fleets.begin();
                    af_it != this->area->active_fleets.end(); ++af_it) {
                std::vector<variable> &f_l =
                        (*af_it)->f_at_age[this->area->id][this->id];
                std::vector<variable> &z_l =
                        (*af_it)->z_at_age[this->area->id][this->id];
                std::fill(f_l.begin(), f_l.end(), static_cast<REAL_T> (0.0));
                std::fill(z_l.begin(), z_l.end(), static_cast<REAL_T> (0.0));
                if (this->sex == mas::MALE) {
                    std::vector<variable> &f_m_l =
                            (*af_it)->f_at_age_males[this->area->id][this->id];
                    std::vector<variable> &z_m_l =
                            (*af_it)->z_at_age_males[this->area->id][this->id];
                    std::fill(f_m_l.begin(), f_m_l.end(), static_cast<REAL_T> (0.0));
                    std::fill(z_m_l.begin(), z_m_l.end(), static_cast<REAL_T> (0.0));
                } else {
                    std::vector<variable> &f_f_l =
                            (*af_it)->f_at_age_females[this->area->id][this->id];
                    std::vector<variable> &z_f_l =
                            (*af_it)->z_at_age_females[this->area->id][this->id];
        ...
        inline void CalculateWeightAtAge() {
            ...
            for (int i = 0; i < ages.size(); ++i) {
                variable a = ages[i];
                length_at_season_start_temp[i] = this->growth_model->Evaluate(a,
                        this->sex);
                length_at_spawning_temp[i] = this->growth_model->Evaluate(
                        a + this->spawning_season_offset, this->sex);
                length_at_catch_time_temp[i] = this->growth_model->Evaluate(
                        a + this->catch_season_offset, this->sex);
                length_at_survey_time_temp[i] = this->growth_model->Evaluate(
                        a + this->survey_season_offset, this->sex);
            ...
            for (int y = 0; y < this->years; y++) {
                for (int s = 0; s < this->seasons; s++) {
                    for (int a = 0; a < ages.size(); ++a) {
                        ...
                        // length at age
                        length_at_season_start[index] =
                                length_at_season_start_temp[a];
                        length_at_spawning[index] = length_at_spawning_temp[a];
                        length_at_catch_time[index] = length_at_catch_time_temp[a];
                        length_at_survey_time[index] =
                                length_at_survey_time_temp[a];
        ...
        inline REAL_T CalculateUnfishedSpawningBiomassPerRecruit() {
            ...
            for (int y = 0; y < this->years; y++) {
                ...
                for (int s = 0; s < this->seasons; s++) {
                    ...
                    size_t index = y * this->seasons * this->ages.size()
                            + (s) * this->ages.size() + plus_group;
                    ntemp0 /= (1.0 - mas::exp(-1.0 * M[plus_group]));

                    sb_per_recruit[y] += ntemp0
                            * (this->weight_at_spawning[index]
            ...
            this->unfished_spawning_biomass_per_recruit =
                    (sb_per_recruit[this->years - 1]);
         ...
         * this->M[this->ages.size() - 1])
         * mas::mfexp(
                            -1.0 * M[plus_index] - z_sum
                            - this->spawning_season_offset
         * P[index] * faa[index]);
                } //end s
            } //end y

            this->fished_spawning_biomass_per_recruit = s_per_recruit[this->years
                    - 1] * this->sex_fraction_value;
            variable ret = s_per_recruit[this->years - 1]
         * this->sex_fraction_value;
            return ret.GetValue();
        }
         */

        inline variable CalculateFishedSpawningBiomassPerRecruit_(REAL_T F) {

            std::vector<variable> faa(this->F.size());
            std::vector<variable> zaa(this->F.size());
                ...
                for (int s = 0; s < this->seasons; s++) {
                    ...
                    for (int a = 0; a < ages.size() - 1; a++) {
                        size_t index = y * this->seasons * this->ages.size()
                                + (s) * this->ages.size() + a;
                        sb_per_recruit[y] += ntemp0
                                * (this->weight_at_spawning[index] * maturity[a]
                                * mas::mfexp(
                                -1.0 * this->spawning_season_offset * zaa[index]));
                        ntemp0 *= mas::mfexp(
                                -1.0 * zaa[index]);
                    ...
                    ntemp0 /= (1.0 - mas::mfexp(-1.0 * zaa[plus_index]));
            ...
            this->fished_spawning_biomass_per_recruit = sb_per_recruit[this->years
                    - 1];
            variable ret = sb_per_recruit[this->years - 1];
        ...
        inline REAL_T CalculateFishedSpawningBiomassPerRecruit(int year, int season,
                REAL_T F) {
        ...
        inline REAL_T CalculateYieldPerRecruit(REAL_T F) {
            ...
            for (int i = 0; i < this->ages.size(); i++) {
                ...
                std::cout
                        ...
                        * this->sum_selectivity[index].GetValue())
                        ...
                        this->years - 1, this->seasons - 1, F) << " * "
                        << this->CalculateProbabilityOfSurvivalToAge(i,
                        this->years - 1, this->seasons - 1, F) << std::endl;
                //                        +
            ...
            return ret
                    + this->CalculateProbabilityOfCaptureAtAgeAOrOlder(
                    this->ages.size() - 1, this->years - 1,
                    this->seasons - 1, F)
                    * this->CalculateProbabilityOfSurvivalToAge(
                    this->ages.size() - 1, this->years - 1,
                    this->seasons - 1, F);

        }

        inline REAL_T CalculateProbabilityOfSurvivalToAge(int a, int year,
                int season, REAL_T F) {
            REAL_T sum_z = 0;
            for (int i = 0; i < a; i++) {
        ...
        inline REAL_T CalculateProbabilityOfCaptureAtAge(int a, int year,
                int season, REAL_T F) {
            size_t index = year * this->seasons * this->ages.size()
        ...
        inline REAL_T CalculateSPR(REAL_T F) {
            variable ret = this->CalculateFishedSpawningBiomassPerRecruit(
                    this->years - 1, this->seasons - 1, F)
        ...
        inline REAL_T CalculateEquilibriumSpawningBiomass(REAL_T F) {
            REAL_T sbpr = this->CalculateFishedSpawningBiomassPerRecruit(
                    this->years - 1, this->seasons - 1, F);

            return this->recruitment_model->CalculateEquilibriumSpawningBiomass(
                    sbpr);
        }
        ...
        void CalculateMaximumSustainableYield(REAL_T &msy, REAL_T &f_msy,
                REAL_T &s_msy) {
        ...
        void CalculateUnfishedEquilSpawningBiomass() {
            if (this->sex == FEMALE) {
                ...
                this->R0 = this->sex_fraction_value
                        * mas::mfexp(this->recruitment_model->log_R0);
        ...
        variable spr_unfished(int year) {
            ...
            for (a = 0; a < this->ages.size(); a++) {
                size_t index = year * this->seasons * this->ages.size()
                        + s * this->ages.size() + a;
                SBtmp +=
                        (Ntmp * this->maturity[a] * this->weight_at_spawning[index]
                        * mas::exp(
                        -1.0 * this->spawning_season_offset
                        * this->M[a]));
            ...
            size_t index = year * this->seasons * this->ages.size()
                    + s * this->ages.size() + a - 1;
            Ntmp /= (mas::exp(-1.0 * this->M[a - 1]));
            SBtmp +=
                    (Ntmp * this->maturity[a - 1] * this->weight_at_spawning[index]
                    * mas::exp(
                    -1.0 * this->spawning_season_offset
                    * this->M[a - 1]));
        ...
        variable spr_ratio(const variable &trial_F, int curryr) {
            ...
            for (jj = 0; jj < this->ages.size(); jj++) {
                size_t index = curryr * this->seasons * this->ages.size()
                        + s * this->ages.size() + jj;
            ...
            size_t index = curryr * this->seasons * this->ages.size()
                    + s * this->ages.size() + jj;
            Ntmp[jj] = avgR;
            SBcurr += (Ntmp[jj] * this->maturity[jj]
                    * this->weight_at_spawning[index]
                    * mas::exp(-1.0 * this->spawning_season_offset * srvtmp[jj]));
            ...
            Ntmp[end_age] = (Ntmp[end_age - 1] * mas::exp(-srvtmp[end_age - 1])
                    / (1.0 - mas::exp(-1.0 * srvtmp[end_age])));
            SBcurr += (Ntmp[end_age] * this->maturity[jj]
                    * this->weight_at_spawning[index]
                    * mas::exp(
                    -1.0 * this->spawning_season_offset * srvtmp[end_age]));
        ...
        variable get_spr_rates(const variable &spr_percent, int curryr) {
            ...
            for (int ii = 1; ii <= 10; ii++) // arbitrary fixed intervals
            {
                ...
                F3 = F1 - df;
                yld1 = /*-1000. */mas::pow(
                        mas::log(spr_percent / spr_ratio(F1, curryr)), 2.0);
                yld2 = /*-1000. */mas::pow(
                        mas::log(spr_percent / spr_ratio(F2, curryr)), 2.0);
                yld3 = /*-1000. */mas::pow(
                        mas::log(spr_percent / spr_ratio(F3, curryr)), 2.0);
        ...
        void BuildBootStrapNumbers() {
            ...
            std::vector<std::vector<REAL_T> > compressed_numbers(this->years,
                    std::vector<REAL_T>(this->ages.size()));

            std::vector<std::vector<REAL_T> > compressed_survivability(this->years,
                    std::vector<REAL_T>(this->ages.size()));
            ...
            NAAbsn[this->ages.size()] =
                    ...
                    * compressed_survivability[this->years - 1][this->ages.size()
                    - 1];
        ...
        inline void FCalc() {
            ...
            std::vector<atl::intrusive_ptr<Fleet<REAL_T> > > &fleets =
                    this->area->seasonal_fleet_operations[1];
            variable wct, wct2;
                ...
                if (fleets[f]->catch_biomass_data.get() != NULL) {
                    ...
                    while (HasConverged == 0) {
                        ...
                        for (int a = 0; a < amax; a++) {
                            ...
                            REAL_T N_ =
                                    this->initial_equilibrium_numbers[a].GetValue();

                            tmp1 =
                                    tmp1
                                    + this->weight_at_catch_time[a].GetValue()/*this->weight_at_catch_time[a].GetValue()*/
                                    * fleets[f]->season_area_selectivity[1][this->area->id]->Evaluate(
                                    this->ages[a]).GetValue()
                                    * MidPoint * N_
                                    * (1.0
                                    - std::exp(
                                    -this->natural_mortality_model->Evaluate(
                                    a).GetValue()
                                    - MidPoint))
                                    / (this->natural_mortality_model->Evaluate(
                                    a).GetValue() + MidPoint);
...
#warning switch to observed catch biomass
         ...
         * @param season
         */
        inline void CalculateMortality(const int &year, const int &season,
                const int &age) {
            ...
            for (int f = 0; f < fleets.size(); f++) {
                ...
                variable ff =
                        fleets[f]->area_season_fishing_mortality[this->area->id][season]->Evaluate(
                        year, (season - 1));

                variable s =
                        fleets[f]->season_area_selectivity[season][this->area->id]->Evaluate(
                        this->ages[age]);

                this->sum_selectivity[index] += s;
                variable f_a_fleet = ff * s;

                fleets[f]->f_at_age[this->area->id][this->id][index] = f_a_fleet;
        ...
        inline void CalculateNumbersAtAge(const int &year, const int &season,
            ...
            if (year == 0 && season == 1) {
                ...
                if (age >= 1) {
                    ...
                    size_t index2 = y * this->seasons * this->ages.size()
                            + (s - 1) * this->ages.size() + age - 1;
                ...
                if (age == this->ages.size() - 1) {
                    ...
                    size_t index1 = year * this->seasons * this->ages.size()
                            + (season - 1) * this->ages.size() + this->ages.size()
                            - 1;
        ...
        void CalculateMSY(REAL_T maxF = 1.0, REAL_T step = 0.001) {
            ...
            std::vector<atl::intrusive_ptr<Fleet<REAL_T> > > &surveys =
                    this->area->seasonal_fleet_operations[season];
            ...
            for (int i = 0; i < surveys.size(); i++) {
                for (int a = 0; a < this->ages.size(); a++) {
                    selectivity[a] += surveys[i]->season_area_selectivity[season][this->area->id]->Evaluate(
                            this->ages[a]);
                }
            }
            ...
            for (i = 1; i < this->ages.size() - 1; i++) {
                size_t index = year * this->seasons * this->ages.size()
                        + (season) * this->ages.size() + i;
                surviavability[i] = mas::exp(-1.0 * (this->M[i] + 0.0 * selectivity[i])) * surviavability[i - 1];
            ...
            surviavability[i] = mas::exp(-1.0 * (this->M[i] + 0.0 * selectivity[i])) * surviavability[i - 1] / (1.0 - mas::exp(-1.0 * this->M[i]));
            ...
            for (int i = 0; i < F.size(); i++) {
                ...
                for (a = 0; a < this->ages.size() - 1; a++) {
                    ...
                    total_mortality[a] = this->M[a] + selectivity[a] * F[i];
                ...
                for (a = 0; a < this->ages.size(); a++) {
                    ...
                    equilibrium_landing_numbers[a] = (F[i] * selectivity[a]) * equilibrium_numbers[a]*(1.0 - mas::exp(-1.0 * total_mortality[a])) / total_mortality[a];
            ...
            //             std::cout << "this->msy.SSB_msy = " << this->msy.SSB_msy << "\n";
...
#warning need to add imigrant and emigrant recruitment biomass here
         ...
         * @param season
         */
        inline void CalculateCatchAtAge(const int &year, const int &season,
                const int &age) {
            ...
            //            }
            this->catch_biomass_total[year * this->seasons + season - 1] +=
                    total_CB;
         ...
         * @param season
         */
        inline void CalculateSurveyNumbersAtAge(const int &year, const int &season,
                const int &age) {
            ...
            for (int s = 0; s < surveys.size(); s++) {
                ...
                variable saa =
                        (surveys[s]->q) * this->numbers_at_age[index]
                        * surveys[s]->season_area_selectivity[season][this->area->id]->Evaluate(
                        this->ages, age)
                        * mas::exp(
                        static_cast<REAL_T> (-1.0)
        ...
        inline void PushToArea() {
            ...
            this->area->PushNumbersAndBiomass(this->survey_numbers_at_age,
                    ...
                    this->recruitment, this->spawning_stock_biomass,
                    this->abundance, this->biomass_total, this->id, sex);
        }
    ...
    std::ostream& operator<<(std::ostream &out, mas::Subpopulation<REAL_T> &pi) {
        ...
        for (int s = 1; s <= pi.seasons; s++) {
            std::vector<atl::intrusive_ptr<Fleet<REAL_T> > > &fleets =
                    pi.area->seasonal_fleet_operations[s];
            if (fleets.size() > 0) {
                for (int f = 0; f < fleets.size(); f++) {
                    for (int y = 0; y < pi.years; y++) {
                        out
                                << fleets[f]->area_season_fishing_mortality[pi.area->id][s]->Evaluate(
                                y, (s - 1)) << " ";
                    }
                    out << "\n";
                }
        ...
        for (int s = 1; s <= pi.seasons; s++) {
            ...
            if (fleets.size() > 0) {
                for (int f = 0; f < fleets.size(); f++) {
                    for (int a = 0; a < pi.ages.size(); a++) {
                        out
                                << fleets[f]->season_area_selectivity[s][pi.area->id]->Evaluate(
                                pi.ages[a]) << " ";
                    }
                    out << "\n";
                }
        ...
        for (int a = 0; a < pi.ages.size(); a++) {
            for (int s = 1; s <= pi.seasons; s++) {
                for (int y = 0; y < pi.years; y++) {
                    out
                            << pi.Z[y * pi.seasons * pi.ages.size()
                            + (s - 1) * pi.ages.size() + a] << " ";
                }
            }
            out << "\n";
        ...
        for (int a = 0; a < pi.ages.size(); a++) {
            for (int s = 1; s <= pi.seasons; s++) {
                for (int y = 0; y < pi.years; y++) {
                    out
                            << pi.numbers_at_age[y * pi.seasons * pi.ages.size()
                            + (s - 1) * pi.ages.size() + a] << " ";
                }
            }
            out << "\n";
        ...
        for (int a = 0; a < pi.ages.size(); a++) {
            for (int s = 1; s <= pi.seasons; s++) {
                for (int y = 0; y < pi.years; y++) {
                    out
                            << pi.catch_at_age[y * pi.seasons * pi.ages.size()
                            + (s - 1) * pi.ages.size() + a] << " ";
                }
            }
            out << "\n";
        ...
        for (int a = 0; a < pi.ages.size(); a++) {
            for (int s = 1; s <= pi.seasons; s++) {
                for (int y = 0; y < pi.years; y++) {
                    out
                            << pi.catch_biomass_at_age[y * pi.seasons
                            * pi.ages.size() + (s - 1) * pi.ages.size() + a]
                            << " ";
                }
            }
            out << "\n";
        ...
        for (int a = 0; a < pi.ages.size(); a++) {
            for (int s = 1; s <= pi.seasons; s++) {
                for (int y = 0; y < pi.years; y++) {
                    out
                            << pi.survey_index_at_age[y * pi.seasons
                            * pi.ages.size() + (s - 1) * pi.ages.size() + a]
                            << " ";
                }
            }
        ...
        for (int a = 0; a < pi.ages.size(); a++) {
            for (int s = 1; s <= pi.seasons; s++) {
                for (int y = 0; y < pi.years; y++) {
                    out
                            << pi.imigrants[y * pi.seasons * pi.ages.size()
                            + (s - 1) * pi.ages.size() + a] << " ";
                }
            }
            out << "\n";
        ...
        for (int a = 0; a < pi.ages.size(); a++) {
            for (int s = 1; s <= pi.seasons; s++) {
                for (int y = 0; y < pi.years; y++) {
                    out
                            << pi.emigrants[y * pi.seasons * pi.ages.size()
                            + (s - 1) * pi.ages.size() + a] << " ";
                }
            }
            out << "\n";
        ...
        for (int y = 0; y < pi.years; y++) {
            for (int s = 1; s <= pi.seasons; s++) {
                for (int a = 0; a < pi.ages.size(); a++) {
                    out
                            << pi.weight_at_spawning[y * pi.seasons * pi.ages.size()
                            + (s - 1) * pi.ages.size() + a] << " ";
                }
            }
            out << "\n";
        ...
        for (int y = 0; y < pi.years; y++) {
            for (int s = 1; s <= pi.seasons; s++) {
                for (int a = 0; a < pi.ages.size(); a++) {
                    out
                            << pi.weight_at_season_start[y * pi.seasons
                            * pi.ages.size() + (s - 1) * pi.ages.size() + a]
                            << " ";
                }
            }
        ...
        for (int a = 0; a < pi.ages.size(); a++) {
            for (int s = 1; s <= pi.seasons; s++) {
                for (int y = 0; y < pi.years; y++) {
                    out
                            << pi.weight_at_catch_time[y * pi.seasons
                            * pi.ages.size() + (s - 1) * pi.ages.size() + a]
                            << " ";
                }
            }
        ...
        for (int a = 0; a < pi.ages.size(); a++) {
            for (int s = 1; s <= pi.seasons; s++) {
                for (int y = 0; y < pi.years; y++) {
                    out
                            << pi.weight_at_survey_time[y * pi.seasons
                            * pi.ages.size() + (s - 1) * pi.ages.size() + a]
                            << " ";
                }
            }
        ...
        for (int y = 0; y < pi.years; y++) {
            for (int s = 0; s < pi.seasons; s++) {
                ...
                for (int a = 0; a < pi.ages.size(); a++) {
                    ...
                    out << pi.ages[a] << "  "
                            << pi.survey_numbers_at_age[y * pi.seasons
                            * pi.ages.size() + (s) * pi.ages.size() + a]
                            << "\n";
                }
                out << "};\n";
    ...
    public:
        ...
        void InitializePopulationinAreas() {
            for (int a = 0; a < areas_list.size(); a++) {
                ...
                initial_deviations_iterator id_it =
                        this->initial_deviations_females.find(areas_list[a]->id);
                if (id_it != this->initial_deviations_females.end()) {
                    ...
                    std::vector<variable> &ldevs =
                            females[areas_list[a]->id].initial_deviations;
                ...
                if (id_it != this->initial_deviations_males.end()) {
                    ...
                    std::vector<variable> &ldevs =
                            males[areas_list[a]->id].initial_deviations;
                    for (int i = 0; i < ldevs.size(); i++) {
        ...
        void Initialize() {
            ...
            for (int a = 0; a < areas_list.size(); a++) {
                ...
                for (it = this->area_season_recruitment[area].begin();
                    ...
                    males[areas_list[a]->id].seasonal_recruitment_models[(*it).first] =
                            (*it).second;
                }
                ...
                for (it = this->area_season_recruitment[area].begin();
                    ...
                    females[areas_list[a]->id].seasonal_recruitment_models[(*it).first] =
                            (*it).second;
                }
            }
        ...
        void Show() {
            ...
            for (int a = 0; a < this->ages; a++) {
                for (int y = 0; y < this->years; y++) {
                    for (int s = 1; s <= this->seasons; s++) {
                        std::cout
                                << this->catch_numbers_at_age[y * this->seasons
                                * this->ages + (s - 1) * this->ages + a]
                                << " ";
                    }
                }
                std::cout << "\n";
            ...
            for (int a = 0; a < this->ages; a++) {
                for (int y = 0; y < this->years; y++) {
                    for (int s = 1; s <= this->seasons; s++) {
                        std::cout
                                << this->catch_biomass_at_age[y * this->seasons
                                * this->ages + (s - 1) * this->ages + a]
                                << " ";
                    }
                }
            ...
            for (int a = 0; a < this->ages; a++) {
                for (int y = 0; y < this->years; y++) {
                    for (int s = 1; s <= this->seasons; s++) {
                        std::cout
                                << this->survey_numbers_at_age[y * this->seasons
                                * this->ages + (s - 1) * this->ages + a]
                                << " ";
                    }
                }
            ...
            for (int a = 0; a < this->ages; a++) {
                for (int y = 0; y < this->years; y++) {
                    for (int s = 1; s <= this->seasons; s++) {
                        ...
                        std::cout
                                << this->survey_biomass_at_age[y * this->seasons
                                * this->ages + (s - 1) * this->ages + a]
                                << " ";
                    }
                }
