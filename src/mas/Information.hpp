        ...
        void CreateModel() {
            ...
            for (ssit = this->survey_models.begin(); ssit != this->survey_models.end();
                ...
                for (it = (*ssit).second->estimated_parameters_map.begin();
                    ...
                    mas_log << mas::VariableTrait<REAL_T>::GetName(*(*it).first) << "\t\t\t\t\t\t"
                            << mas::VariableTrait<REAL_T>::GetValue(*(*it).first) << "\t\t\t\t\t\t" << (*it).second
                            << "\n";
                    std::cout << mas::VariableTrait<REAL_T>::GetName(*(*it).first) << "\t\t\t\t\t\t"
                            << mas::VariableTrait<REAL_T>::GetValue(*(*it).first) << "\t\t\t\t\t\t" << (*it).second
                            << "\n";
