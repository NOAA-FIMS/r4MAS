...
require(Rcpp)
require(r4MAS)
d <- system.file(package = "r4MAS")
r4mas <-
  Module("rmas", dyn.load(paste(d,"/libs/x64/r4MAS", .Platform$dynlib.ext, sep = "")))
```


## Setting model specifications

Next, we define model scalars, such as the number of years of the model, the number of seasons, and the vector of ages. For this example, we will use the test data created by `r4mas::write_test_data()`, but this can be replaced by user input data later on in the script.
