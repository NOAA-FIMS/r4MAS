...
test_that(
  "External OM test: singlespecies with bias correction in recruitment",{
    ...
    recruitment$R0$value <- om_input$mean_R0 / 1000
    recruitment$R0$estimated <- TRUE
    recruitment$R0$phase <- 1
    recruitment$h$value <- om_input$mean_h
