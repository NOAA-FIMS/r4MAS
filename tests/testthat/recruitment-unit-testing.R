...
# Fix recruitment settings in RMAS and Run RMAS
# Compare model outputs with true values from model comparison project OM

test_that(
  "Recruitment-checking SR models", {
  ...
  expect_equal(object = unlist(pop$undifferentiated$recruits$values),
